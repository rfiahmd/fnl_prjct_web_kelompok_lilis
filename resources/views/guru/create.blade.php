                    ...
                    <div class="card-body">
                        <form action="{{ route('guru.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nuptk" class="form-control @error('nuptk') is-invalid @enderror" id="nuptk" value="{{ old('nuptk') }}" required>
                                @error('nuptk')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                                </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nomor_hp" class="form-control @error('nomor_hp') is-invalid @enderror" id="nomor_hp" required>{{ old('nomor_hp') }}</input>
                                    @error('nomor_hp')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
